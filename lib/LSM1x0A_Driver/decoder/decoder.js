...
// Test function
// 000A01010105FF0001 // MICA CONF
// 0202002D57454C4C5F4C4F52415F3030305F5641434D4943415F57454C4C08D1F94252F401000000258001 // MICA INFO
// 0100CF021203A6FFFF001D0002000200020002FFFFFFFFFFFF000057454C4C004564414BFF00 // MICA DATA

function textToBytes(hexString) {
  var bytes = [];
...
function testDecode(hexString) {
  if (!hexString) {
    hexString =
      "0100CF021203A6FFFF001D0002000200020002FFFFFFFFFFFF000057454C4C004564414BFF00";
  }
  var bytes = textToBytes(hexString);
  var decoded = decodeUplink({ bytes: bytes }).data;
  console.log(decoded);
}

// Call the test function
testDecode(
  "0202002D57454C4C5F4C4F52415F3030305F5641434D4943415F57454C4C08D1F94252F401000000258001",
);
